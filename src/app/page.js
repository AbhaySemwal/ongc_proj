      ...
      <div className="border-[1px] border-gray-500 text-[8px] md:text-base">
        ...
        {patient?.map((pt, index) => (
          <div key={index} className="grid grid-cols-6">
            <div className="border-[1px] border-gray-500 p-1 text-ellipsis overflow-hidden">{index + 1}</div>
            <div className="border-[1px] border-gray-500 p-1 text-ellipsis overflow-hidden">{pt.name}</div>
            <div className="border-[1px] border-gray-500 p-1 text-ellipsis overflow-hidden">{pt.dob}</div>
            <div className="border-[1px] border-gray-500 p-1 text-ellipsis overflow-hidden">{pt.gender}</div>
            <div className="border-[1px] border-gray-500 p-1 text-ellipsis overflow-hidden">{pt.contact}</div>
            <div className="border-[1px] border-gray-500 p-1 text-ellipsis overflow-hidden">{pt.test}</div>
          </div>
        ))}
